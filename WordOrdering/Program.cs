...
namespace WordOrdering
{
    // Class: Program
    // Author: Melodie Wang/Prof
    // Purpose: sorts sentance's words into alphabetical
    // Restrictions: None
    internal class Program
    {
        // Method: Main
        // Purpose: takes string input, converts to array, orders alphabetically
        // Restrictions: None
        ...
        static void Main(string[] args)
        {
            ...
            // iterate through the array AND COUNTS NUM WORDS
            ...
            while (aUnsorted.Length > 0)
            {
                ...
                // increment the strings of values in the sorted array
                ++nSortedLength;
            }
