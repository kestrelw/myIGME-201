    ...
    public partial class LinkedList : Form
    {
       ...
       */
        ...
        private void Button3__Click(object sender, EventArgs e)
        {
            ...
            // 2. Your code here
            linkedList = new LinkedList<object>(new[] { "the", "fox", "jumped", "over", "the", "dog" });
        ...
        private void Button4__Click(object sender, EventArgs e)
        {
            ...
            // 2. Your code here
            linkedList = new LinkedList<object>(new[] { "Because", "I'm", "sad", "Clap", "along", "if", "you", "feel", "like", "a", "room", "without", "a", "roof", "Because", "I'm", "sad", "Clap", "along", "if", "you", "feel", "like", "sadness", "is", "the", "truth", "sad" });
        ...
        private void Button5__Click(object sender, EventArgs e)
        {
            ...
            // 2. Your code here
            linkedList = new LinkedList<object>(new[] { "The", "Spain", "in", "rain", "falls", "plain", "on", "the", "mainly" });
            ...
            linkedList.Remove(linkedList.Find("Spain"));
            linkedList.Remove(linkedList.Find("rain"));
            linkedList.AddBefore(inNode, "rain");
            linkedList.AddAfter(inNode, "Spain");
            linkedList.Remove(linkedList.Find("mainly"));
            linkedList.Remove(linkedList.Find("plane"));
            linkedList.AddAfter(linkedList.Find("falls"), "mainly");
            linkedList.AddAfter(linkedList.Find("the"), "plane");
